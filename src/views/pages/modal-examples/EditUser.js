    ...
    <Fragment>
      <Card>
        <CardBody className='text-center'>
          ...
          <br />
          <span style={{ backgroundColor: "lightblue", padding: "3px", borderRadius: "5px" }}>NSE</span> &nbsp;
          <span style={{ backgroundColor: "lightgreen", padding: "3px", borderRadius: "5px" }}>BSE</span>
          <br />
          <br />
          <CardTitle tag='h5'>ANGEL ONE</CardTitle>
          <CardText>Client ID : T10695</CardText>
