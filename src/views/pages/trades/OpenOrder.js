...
const OpenOrder = () => {
  ...
  const column = [
    ...
    },
    {
      ...
      cell: row => (
        <Badge color={row['Exchange'].includes('-') ? 'light-danger' : 'light-success'} pill>
          {row['Exchange'].includes('+') ? (
            <>
              {row['Exchange']}
            </>
          ) : (
    ...
    },
    {
      ...
      sortable: true,
      minWidth: '150px',
      selector: row => row['Brokers'],
      cell: row => (
        <Badge color={row['Brokers'].includes('-') ? 'light-danger' : 'light-success'} pill>
          {row['Brokers'].includes('+') ? (
            <>
              {row['Brokers']}
            </>
          ) : (
